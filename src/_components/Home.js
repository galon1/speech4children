...
class Home extends React.Component {
    ...
    render() {
        return (
            ...
            <p ><Header /></p>
            <p className ="cover-page-description">
          ...
          <br /><Button className="learn-more" onClick={() => { window.open("./about", "_self")}}>Read More</Button> </p>     
