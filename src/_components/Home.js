...
class Home extends React.Component {
    ...
    render() {
        return (
          ...
          <br /><Button className="learn-more" onClick={() => { window.open("./about", "_self")}}>Read More</Button></h1></div>     
                <h1 className="purple-description">The Speech4Children clinic focuses on a variety of pediatric speech and language disorders including pragmatic and social disorders, autism, articulation disorders including speech motor disorders, and developmental language disorders.</h1>
            <div className="wrapper">
